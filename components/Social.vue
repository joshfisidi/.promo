<template>
    <div
      ...
      class="Alert flex justify-center items-center bg-cyan-500 rounded px-2 py-1 mx-7 lg:mx-20 my-4 text-black font-bold mby-2 transition-all duration-200 ease-in-out transform active:scale-90 cursor-pointer"
    >
